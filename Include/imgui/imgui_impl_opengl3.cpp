    // Suppress narrowing and signed/unsigned conversion warnings for this file only
#ifdef _MSC_VER
#pragma warning (push)
...
// (keep diagnostics push active until end of file)
...
void    ImGui_ImplOpenGL3_Shutdown()
{
    ...
    ImGuiIO& io = ImGui::GetIO();
    ImGuiPlatformIO& platform_io = ImGui::GetPlatformIO();
    (void)platform_io; // No-op placeholder to ensure file context is loaded before adding pop.
